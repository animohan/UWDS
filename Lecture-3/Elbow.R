...
#IQ is not normalized has more impact

# 7.) Under which conditions do clusters separate the most on IQ?
#when !Q is not normalized
...
# Load the data
fileName <- "StudentPlans.csv"
DATAFRAME <- read.csv(file=fileName, header=TRUE, stringsAsFactors=FALSE)
